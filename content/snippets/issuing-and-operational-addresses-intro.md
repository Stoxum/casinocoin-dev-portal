In the CSC Ledger, financial institutions typically use multiple CSC Ledger addresses to minimize the risk associated with a compromised secret key. Stoxum strongly recommends the following separation of roles:
